...
class FashionBlogA {
  ...
  public function get() {
    return [
      'name' => __("Women Fashion Store", 'mailpoet'),
                ...
                'blocks' =>
                 [
                  0 =>
                   [
                    'type' => 'text',
                    'text' => '<p style="text-align: right;"><a href="[link:newsletter_view_in_browser_url]" style="color: #b76e97; font-size: 12px;">' . __("View this in your browser.", 'mailpoet') . '</a></p>',
                   ],
                 ],
               ],
             ],
