...
class __TwigTemplate_71b036b7f22592892987288406b287adc5134f8454b897deb37074c64d784d1a extends Template
{
  ...
  ";
        // line 22
        yield from         $this->loadTemplate("subscribers/importExport/import/step_data_manipulation.html", "subscribers/importExport/import.html", 22)->unwrap()->yield($context);
        // line 23
...
";
        // line 37
        yield $this->extensions['MailPoet\Twig\I18n']->localize(["noMailChimpLists" => $this->extensions['MailPoet\Twig\I18n']->translate("No active lists found"), "serverError" => $this->extensions['MailPoet\Twig\I18n']->translate("Server error:"), "select" => $this->extensions['MailPoet\Twig\I18n']->translate("Select", "Form input type"), "wrongFileFormat" => $this->extensions['MailPoet\Twig\I18n']->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => MailPoetVendor\Twig\Extension\CoreExtension::replace($this->extensions['MailPoet\Twig\I18n']->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), ["%s" =>         // line 42
...
";
    ...
    {
        return array (  119 => 142,  117 => 42,  116 => 37,  110 => 34,  106 => 33,  102 => 32,  97 => 30,  93 => 29,  89 => 28,  82 => 23,  80 => 22,  73 => 18,  59 => 7,  54 => 4,  50 => 3,  45 => 2,  43 => 1,  36 => 2,);
    }
